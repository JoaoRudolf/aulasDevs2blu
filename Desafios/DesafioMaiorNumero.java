	...
	public static void main(String[] args) {
		...
		try {
			qtdNumeros = Integer.parseInt(
					JOptionPane.showInputDialog("Informe a quantidade de números a ser digitada"));
			...
			for (int i = 0; i < conjuntoNumeros.length; i++) { // for para armazenamento dos números no array
				conjuntoNumeros[i] = Double
						.parseDouble(JOptionPane.showInputDialog("Digite o número " + (i + 1) + "º número").replace(",", "."));
